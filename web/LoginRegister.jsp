<%-- 
    ...
    Created on : 22-Mar-2021, 13:44:53
    Author     : hp
--%>
                ...
                <div class="container">
                    <div class="signin-content">
                        ...
                        <div class="signin-form">
                            <a href="ControllerProduct"><img src="https://i.pinimg.com/originals/77/c3/66/77c366436d8bd35fe8b3ce5b8c66992e.png" width="60px" height="60px" /></a>
                            <h2 class="form-title">Sign in</h2>

                            <form method="POST" class="register-form" action ="login" id="login-form">
                                <div class="form-group">
                                    <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                    <input type="text" name="user" id="your_name" placeholder="User Name" required/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="admin">
                                        <input type="password" name="code" id="your_pass1" placeholder="Security Code"/>
                                    </div>    
                                </div>
                            ...
                            <div class="signup-form">
                                ...
                                <form method="POST" action="register" class="register-form" id="register-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="user" id="name" placeholder="User Name" required />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="email"><i class="zmdi zmdi-email"></i></label>
                                        <input type="number" name="phone" id="email" placeholder="Phone Number"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="email"><i class="zmdi zmdi-email"></i></label>
                                    ...
                                    <div class="form-group">
                                        <input name="address" type="text" id="user-repeatpass" class="form-control" placeholder="Address" required autofocus="" required>
                                    </div>
                                    <!--<p>What is your dream job?</p>-->
                                    <div class="form-group">
                                        <input name="ans" type="text" id="user-repeatpass" class="form-control" placeholder="What is your dream job?" required autofocus="">
                                    </div>  
                                    <!--                                <div class="form-group">
