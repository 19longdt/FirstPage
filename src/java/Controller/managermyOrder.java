 ...
 * @author hp
 */
@WebServlet(name = "managermyOrder", urlPatterns = {"/managermyOrder"})
public class managermyOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            List<OrderDetail> od = dao.getOrderByAccount(id);
        ...
        //            List<OrderDetail> od = dao.getOrderByAccount(session.getAttribute("acc").toString());
        //            request.setAttribute("myorder", od);
        //            request.getRequestDispatcher("ManagerMyOrder.jsp").forward(request, response);
        ////                response.sendRedirect("managermyOrder");
        //        }
